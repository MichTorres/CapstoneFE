...
function ItemSession(props) {
  console.log("ItemSession.props: " + props);
  ...
  const handleClickEdit = event => {
    console.log("Edit the Session");
    history.push("/editSession/" + props.item.id);
  };
  ...
  return (
    <Card className={classes.itemSession}>
